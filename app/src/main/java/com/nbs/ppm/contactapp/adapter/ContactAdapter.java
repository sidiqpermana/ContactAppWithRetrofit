...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.PersonViewHolder> {
    ...
    Activity activity;
    ArrayList<Contact.ItemContact> listItem;

    public ContactAdapter(Activity activity, ArrayList<Contact.ItemContact> listItem){
    ...
    public void onBindViewHolder(PersonViewHolder personViewHolder, final int i) {
        personViewHolder.txtName.setText(listItem.get(i).name);
        personViewHolder.txtPhone.setText(listItem.get(i).phone);
        personViewHolder.txtEmail.setText(listItem.get(i).email);

        final Contact.ItemContact itemContact = listItem.get(i);
        personViewHolder.item.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FormCreateUpdateActivity.toFormCreateUpdateActivity(activity, itemContact, i);
            }
        });
